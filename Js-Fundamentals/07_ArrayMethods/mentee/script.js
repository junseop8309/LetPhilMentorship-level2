...
let mentees = ["Bob", "Katy", "Joe"];
mentees.forEach((mentee) => console.log(`Hello, ${mentee}! Ready to code?`));
...
let labeledNumbers = numbers.map((num) => `Value: ${num}`);
...
let evenNumbers = bigNumbers.filter((num) => num % 2 === 0);
